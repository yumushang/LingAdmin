 ...
 */
public class TSysUsergroupRoleCriteria {
    /** 
     * 排序字段
    */
    ...
    */
     ...
     * 构造查询条件
     */
    public TSysUsergroupRoleCriteria() {
    ...
    /**
     * 用户组表与角色表的关联表t_sys_usergroup_role
     */
    ...
    /**
     * 用户组表与角色表的关联表t_sys_usergroup_role的映射实体
     */
    ...
    /**
     * 用户组表与角色表的关联表t_sys_usergroup_role的动态SQL对象.
     */
