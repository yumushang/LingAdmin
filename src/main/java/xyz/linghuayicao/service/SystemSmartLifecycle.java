package xyz.linghuayicao.service;
...
@Component
public class SystemSmartLifecycle implements SmartLifecycle {

    private boolean isRunning = false;


    private static Logger logger = LoggerFactory.getLogger(SystemSmartLifecycle.class);
    ...
    //初始化年份月份数据
    private void setYearAndMonth() throws Exception {
